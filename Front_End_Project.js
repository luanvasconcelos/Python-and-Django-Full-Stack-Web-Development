...
var player1 = prompt("Player One: Enter Your Name , you will be Orange");
var player1Color = 'rgb(255, 119, 0)';

var player2 = prompt("Player Two: Enter Your Name, you will be Purple");
var player2Color = 'rgb(57, 0, 112)';
...
$('.board button').on('click',function() {
  ...
  if (currentPlayer === 1) {
    currentName = player1;
    $('h3').text(currentName+": it is your turn, please pick a column to drop your orange chip.");
